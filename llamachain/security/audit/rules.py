...
class RuleSet:
    ...
    def _default_rules(self) -> List[Rule]:
        ...
        return [
            ...
            Rule(
                ...
                patterns=[r"pragma\s+solidity\s+(?:0\.[1-7]\.|^0\.8\.0)"],
            ...
            Rule(
                ...
                severity=Severity.LOW,
                patterns=[r"pragma\s+solidity\s+[\^~>]"],
            ...
            Rule(
                ...
                severity=Severity.LOW,
                patterns=[r"suicide\s*\(", r"block\.blockhash", r"sha3\s*\("],
    ...
    def remove_rule(self, vulnerability_type: str) -> None:
        ...
        """
        self.rules = [
            rule for rule in self.rules if rule.vulnerability_type != vulnerability_type
        ]
