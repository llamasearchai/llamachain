...
class NLPProcessor:
    ...
    def __init__(self):
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    self.nlp = None
                    logger.warning(
                        "No spaCy model available, some NLP features will be limited"
                    )
        except ImportError:
        ...
        try:
            ...
            logger.warning(
                "transformers not available, some NLP features will be limited"
            )

        logger.info(
            f"NLP processor initialized (spaCy: {self.spacy_available}, transformers: {self.transformers_available})"
        )
    ...
    async def translate_to_query(
        self, processed_query: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
