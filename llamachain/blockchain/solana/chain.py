...
class SolanaChain(BlockchainBase):
    ...
    async def get_transaction(self, tx_hash: str) -> Dict[str, Any]:
        ...
        """
        try:
            params = [tx_hash, {"encoding": "json", "commitment": self.commitment}]
    ...
    async def get_gas_price(self) -> int:
        ...
        try:
            ...
            params = [100, {"commitment": self.commitment}]  # Size of 100 bytes
    ...
    async def send_raw_transaction(self, tx_hex: str) -> str:
        ...
        """
        try:
            params = [tx_hex, {"encoding": "base64", "commitment": self.commitment}]
    ...
    async def call_contract(
        ...
        try:
            ...
            self.logger.error(
                f"Error calling program {address}.{function_signature}: {e}"
            )
            return None
