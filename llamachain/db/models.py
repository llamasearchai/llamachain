...
class WatchlistItem(Base):
    ...
    alerts = relationship(
        "Alert", back_populates="watchlist_item", cascade="all, delete-orphan"
    )
...
class Contract(Base):
    ...
    # Relationships
    audits = relationship(
        "Audit", back_populates="contract", cascade="all, delete-orphan"
    )
    vulnerabilities = relationship(
        "Vulnerability", back_populates="contract", cascade="all, delete-orphan"
    )

    # Constraints
    __table_args__ = (UniqueConstraint("blockchain", "address", name="uq_contract"),)
