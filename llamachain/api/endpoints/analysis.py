...
async def get_price_history(
    ...
    interval: str = Query(
        "1h", description="Price interval (1m, 5m, 15m, 30m, 1h, 4h, 1d)"
    ),
):
    """
...
async def get_price_correlation(
    tokens: List[str] = Query(
        ..., description="List of token symbols to analyze correlation"
    ),
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Error getting price correlation: {str(e)}"
        )
...
async def detect_address_patterns(
    ...
    days: int = Query(
        30, description="Number of days of transaction history to analyze"
    ),
):
    """
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Error detecting address patterns: {str(e)}"
        )
...
async def detect_network_anomalies(
    ...
    threshold: float = Query(
        2.0, description="Anomaly detection threshold (standard deviations)"
    ),
):
    """
    ...
    try:
        ...
        result = await pattern_detector.detect_network_anomalies(
            chain, hours, threshold
        )
        ...
        raise HTTPException(
            status_code=500, detail=f"Error detecting network anomalies: {str(e)}"
        )
...
async def get_transaction_metrics(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Error getting transaction metrics: {str(e)}"
        )
...
async def get_address_metrics(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Error getting address metrics: {str(e)}"
        )
...
async def classify_address(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Error classifying address: {str(e)}"
        )
...
async def get_address_network(
    ...
    tx_limit: int = Query(
        1000, description="Maximum number of transactions to analyze"
    ),
):
    """
    ...
    try:
        ...
        # Get address network
        result = await viz_generator.get_address_network(
            chain, address, depth, tx_limit
        )
        ...
        raise HTTPException(
            status_code=500, detail=f"Error getting address network: {str(e)}"
        )
...
async def get_token_flow_visualization(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Error getting token flow visualization: {str(e)}"
        )
...
async def get_activity_heatmap(
    chain: str = Path(..., description="Blockchain (ethereum, solana)"),
    metric: str = Query(
        "transactions", description="Metric to visualize (transactions, gas, volume)"
    ),
    days: int = Query(7, description="Number of days to analyze"),
):
    """
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Error getting activity heatmap: {str(e)}"
        )
...
async def get_gas_price_visualization(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Error getting gas price visualization: {str(e)}"
        )
...
async def get_contract_activity_visualization(
    ...
    try:
        ...
        result = await viz_generator.get_contract_activity(
            chain, address, days, interval
        )
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Error getting contract activity visualization: {str(e)}",
        )
...
async def get_defi_metrics(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Error getting DeFi metrics: {str(e)}"
        )
...
async def get_nft_metrics(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Error getting NFT metrics: {str(e)}"
        )
...
async def predict_token_price(
    ...
    model_type: str = Body(
        "prophet", description="Prediction model to use (prophet, lstm, arima)"
    ),
):
    """
    Predict token price.
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Error predicting token price: {str(e)}"
        )
...
async def predict_gas_price(
    chain: str = Body(
        "ethereum", description="Blockchain (currently only ethereum supported)"
    ),
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Error predicting gas price: {str(e)}"
        )
