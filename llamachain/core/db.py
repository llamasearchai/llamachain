...
class Database:
    ...
    def store_vulnerability(
        self, audit_id: int, vulnerability_data: Dict[str, Any]
    ) -> bool:
        """
    ...
    def get_transactions_by_address(
        self, chain_id: str, address: str, limit: int = 100, offset: int = 0
    ) -> List[Dict[str, Any]]:
        """
    ...
    def get_latest_audit(
        self, chain_id: str, contract_address: str
        ...
        try:
            ...
            if row:
                ...
                audit_data["vulnerabilities"] = self.get_vulnerabilities(
                    audit_data["id"]
                )
