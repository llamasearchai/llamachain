...
class KeywordExtractor(Component):
    ...
    DEFAULT_STOP_WORDS = {
        ...
        "such", "when", "who", "whom", "how", "where", "why", "is", "are", "was",
        "were", "be", "been", "being", "have", "has", "had", "having", "do", "does",
        "did", "doing", "will", "would", "shall", "should", "can", "could", "may",
        "might", "must", "of", "to", "in", "for", "on", "by", "about", "against",
        "between", "into", "through", "during", "before", "after", "above", "below",
        "from", "up", "down", "with", "over", "under", "again", "further", "then",
    ...
    def process(self, input_text: str) -> List[Dict[str, Any]]:
        ...
        for word, count in word_counts.items():
            ...
            length_factor = math.log(len(word) + 1) / math.log(20)  # Normalize to 0-1 range
